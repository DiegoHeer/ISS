...
def ask_ticker_to_user():
    ...
    try:
        ...
        pymsgbox.alert("Ticker entered is invalid. Please try again.", "Assertion Error")
        exit()
...
def get_fs_dir_path():
    # This function gets the directory where the financial statements generated by quickfs_scraping module are
